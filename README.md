...
Currently, only images and videos can be uploaded, and editing is only possible on PCs. Future development will include support for many file formats and devices, as well as the addition of more convenient features. Please look forward to it.
